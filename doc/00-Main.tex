...
\textsc{\Large Informatikprojekt PAWI}\\[1.5cm] % Major heading such as course name
...
% Rafael \textsc{Stalder}\\
% Dominik \textsc{Zgraggen}
...
% \IfFileExists{01}
            % {\input{01}}
            % {\typeout{Hinweis: Datei "01" fehlt und wird ausgelassen.}}
