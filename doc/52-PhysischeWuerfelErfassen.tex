...
\begin{description}
	...
	Der folgende Code ausschnitt startet die ARSession sowie den Klassifizierungsprozess. Da dieser Task performance intensive ist können nur eine gewisse Anzahl Bilder analisiert werden. Es wird stehts geprüft ob sich bereits ein Bild im Buffer befindet bevor ein neues Bild zur Auswertung freigegeben wird.
	\begin{code}{arkit-recognition-configuration}{Startet die ARSession und den Klassifizierungsprozess}
